...
$(function(){
  ...
  $(".beginShoping").click(function(event){
    $(".section8").fadeOut(2000)
  })

  

  $('#backgroundAudio').click(function(event){
    if(!play){
      $("#backgroundAudio")[0].play();
      play = true;
    }
  ...
  $('#fullpage').fullpage({ // fullpage  方法里面接受json对象形式
    ...
    afterLoad: function(anchorLink, index) {
      ...
      if(index == 2) {
        ...
        $(".search").show().animate({"right": 370}, 1500, "easeOutBack", function() {
          // 方块走进来，沙发2个字显示
          $(".search-wrods").animate({"opacity": 1, "left": 70},500, function() {
            $(".search").hide();
            // 图片 往右上角， 缩小
    ...
    onLeave: function(index, nextIndex, direction) {
      ...
      if(index == 3 && nextIndex == 4 ) {
        ...
        $(".t1f").show().animate({"bottom" : -((k - 250) + 50)}, 2000, function() {
